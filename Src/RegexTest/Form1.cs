...
namespace RegexTest
{
	...
	public class Form1 : System.Windows.Forms.Form, IRegexTestView
	{
		...
		{
			string csharpSource = stringMaker.MakeCSharpString(RegexText.Text, CreateRegexOptions());
		...
		{
			string vbSource = stringMaker.MakeVBString(RegexText.Text, CreateRegexOptions());
